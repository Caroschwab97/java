...
public class ListaDeEnterosEnlazada extends ListaDeEnteros {
	...
	public void leerLista (ListaDeEnterosEnlazada list) {
			System.out.println(list.inicio.getDato());
			while (list.inicio.getSiguiente() != null) {
				inicio = list.inicio.getSiguiente();
				System.out.println(list.inicio.getDato());
	}}
